// Satrapia_txt.cpp : Defines the entry point for the console application.
//
...
# endif
	...
	for (;;)
	{
		...
		for (j = 0; messages[j] != NULL; j++)
		{
			...
			char *scrollbuf = (char*) malloc(scroll_len);
